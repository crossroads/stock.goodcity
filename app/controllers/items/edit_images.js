...
export default Ember.Controller.extend({
  ...
  initPreviewImage: Ember.on(
    "init",
    Ember.observer("model", "model.images.[]", function() {
      var image =
  ...
  actions: {
    ...
    deleteImage() {
      if (this.get("item.images.length") === 1) {
        ...
        this.get("messageBox").confirm(
          this.get("intl").t("edit_images.delete_confirm"),
          () => {
    ...
    uploadProgress(e, data) {
      ...
      this.set(
        "loadingPercentage",
        this.get("intl").t("edit_images.image_uploading") + progress + "%"
      );
    },
    ...
    uploadComplete(e) {
      ...
      this.set("addPhotoLabel", this.get("intl").t("edit_images.add_photo"));
      this.set(
        "loadingPercentage",
        this.get("intl").t("edit_images.image_uploading")
      );
    },
