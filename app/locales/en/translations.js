export default {
  ...
  unavailable_record: 'Unfortunately, the details that you are looking for are not here.',
  okay: 'Okay',
  'language.en': 'English',
  'language.zh': '中文',
  ...
  stocktakes: {
    ...
    tips: {
      ...
      review_tab: "Head over to the 'Review' tab to see the full list of expected items",
    },
    errors: {
      name_exists: 'Another stocktake with the same name already exists',
      stocktake_exists_for_location: 'Warning: A stocktake already exists for this location',
    },
    states: {
      open: 'Open',
      closed: 'Closed',
  ...
  box_pallet: {
    indicate_amount: 'Indicate how many are you taking from each of the locations below.',
    available: 'Available',
    location: 'Location',
    quantity: 'Quantity',
    ...
    details: 'details',
    bad_item: 'Bad item',
    invalid_quantity: 'Added quantity cannot be greater than the available quantity for each location.',
  ...
  messages: {
    ...
    item_chat_permission_error: 'You are not authorized to send messages on items.',
    send: 'Send',
    day: {
      today: 'Today',
      morning: 'Morning',
  ...
  order_filters: {
    ...
    carry_out_info: 'Overseas organisation that self-arrange logistics for a small order',
    dispatch: 'Dispatch',
  ...
  order: {
    ...
    international: {
      ...
      errors: {
        ...
        code_error: 'Must be a 4 or 5 digit Number (a letter suffix is optional)',
      },
    },
    client_information: {
  ...
  organisation: {
    ...
    country: 'Country',
    type: 'Type',
    cancel_warning: 'You will lose all your data. Are you sure you want to cancel this?',
    validation_error: {
  ...
  users: {
    cancel_user_warning: 'You will lose all your data. Are you sure you want to cancel this User?',
    title: 'Title',
    image: 'Image',
    add_image: 'Add Image',
    ...
    details: {
      ...
      disabled_user_info: 'User will be denied access to all apps including donor app.',
      disabled_user_note:
    ...
    contact_details: {
      ...
      unauthorised_error: 'Sorry, you are not authorised to edit details for this user.',
    },

    roles: {
      admin_app_details: 'Admin App Details',
      unauthorised_error: 'Sorry, you are not authorised to update roles for this user.',
      ...
      admin_role_error: 'Access to Admin App requires at least one role to be assigned.',
      admin_printer_label: 'Preferred Label Printer in Admin App',
      stock_app_details: 'Stock App Details',
      stock_role_error: 'Access to Stock App requires at least one role to be assigned.',
      stock_printer_label: 'Preferred Label Printer in Stock App',
