...
export default cloudinaryUrl.extend(GradeMixin, {
  ...
  isDesignated: Ember.computed('ordersPackages', 'ordersPackages.[]', 'ordersPackages.@each.state', function() {
  ...
  lockedQty: Ember.computed('ordersPackages', 'ordersPackages.[]', 'ordersPackages.@each.state', function() {
  ...
  onHandQty: Ember.computed('receivedQuantity', 'dispatchedQuantity', function() {
  ...
  hasOneDesignatedPackage: Ember.computed('ordersPackages.@each.state', function() {
    ...
    return designatedOrdersPackages.get('length') > 1 || designatedOrdersPackages.get('length') === 0
      ? false
  ...
  hasOneDispatchedPackage: Ember.computed('ordersPackages.@each.state', function() {
    ...
    return dispatchedOrdersPackages.get('length') > 1 || dispatchedOrdersPackages.get('length') === 0
      ? false
  ...
  locations: Ember.computed('packagesLocations.[]', 'packagesLocations.@each.location', function() {
  ...
  setImages: Ember.computed('packageSet.items.@each.imageUrlList.[]', function() {
   ...
   */
  siblings: Ember.computed('isPartOfSet', 'packageSet.items.@each.packageSetId', 'packageSet.items.[]', function() {
