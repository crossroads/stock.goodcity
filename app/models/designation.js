...
export default Model.extend({
  ...
  appointmentTransportLabel: Ember.computed('orderTransport.transportType', function() {
  ...
  stateText: Ember.computed('orderTransport', 'bookingType', 'detailType', function() {
  ...
  appointmentTime: Ember.computed('orderTransport.scheduledAt', 'orderTransport.timeslot', function() {
  ...
  isDelivery: Ember.computed('orderTransport.transportType', function() {
  ...
  hasUnreadStaffMessages: Ember.computed('unreadStaffMessagesCount', function() {
