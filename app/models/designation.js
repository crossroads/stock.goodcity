...
export default Model.extend({
  ...
  isRemoteShipmentOrder: Ember.computed.equal("detailType", "RemoteShipment"),
  ...
  isInternationalShipmentOrder: Ember.computed.or(
    "isShipmentOrder",
    "isRemoteShipmentOrder",
    "isCarryOutOrder"
  ),
  ...
  stateText: Ember.computed(
    ...
    function() {
      if (this.get("isAppointment")) {
        ...
        return "shipment";
      } else if (this.get("isRemoteShipmentOrder")) {
  ...
  transportIcon: Ember.computed(
    ...
    function() {
      if (this.get("isAppointment") || this.get("isStockitLocalOrder")) {
        ...
        this.get("isShipmentOrder") ||
        this.get("isRemoteShipmentOrder")
      ) {
        return "ship";
      } else if (this.get("isCarryOutOrder")) {
        return "shopping-bag";
