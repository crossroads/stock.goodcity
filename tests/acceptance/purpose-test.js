...
var App, identity_type, beneficiary, designation, item, orders_package, orders_purpose, purpose, bookingType;
...
module('Acceptance: Order Client summary', {
  beforeEach: function() {
    ...
    designation = FactoryGuy.make("designation", { detailType: "GoodCity", code:"GC-00001", beneficiary: beneficiary });
